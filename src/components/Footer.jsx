...
const Footer = () => (
  <section className="col-span-12">
      ...
      <ul className="w-full h-full flex justify-evenly items-center text-xs gap-x-20 dark:border-border-slate dark:bg-main-gray">
        ...
        <li className=" flex flex-col items-center justify-center cursor-pointer dark:bg-slate-300 dark:p-3 dark:rounded-xl">
          <img
            ...
            alt="footer"
          />
          <span>طراحی شده توسط <Link to="https://www.instagram.com/mehdio_021" target="_blank" className="text-xl text-slate-900 dark:text-cyan-600 hover:dark:text-rose-600 transition-all duration-200 hover:dark:text-2xl hover:text-rose-500 hover:text-2xl">mehdio-021</Link></span>
        </li>
        <li className=" flex flex-col items-center justify-center cursor-pointer dark:bg-slate-300 dark:p-3 dark:rounded-xl">
          <img
    ...
    <div className="w-full h-auto justify-between pt-4 pb-24 md:pb-4 border-t-2 border-slate-50  md:px-6 flex dark:bg-main-gray dark:border-slate-500">
      <ul className=" gap-2 text-slate-500 hidden md:flex flex-col text-sm">
        <li className="text-slate-800 text-lg mb-2 dark:text-text-gray">
          با دیجی شاپ
        </li>
        <li className="cursor-pointer">تماس با دیجی شاپ</li>
        <li className="cursor-pointer">گزارش تخلف در دیجی شاپ</li>
        <li className="cursor-pointer">فروش در دیجی شاپ</li>
        <li className="cursor-pointer">درباره دیجی شاپ</li>
      </ul>
    ...
    <div className="w-full md:w-auto px-4">
      <p className="text-slate-800 text-lg mb-2 dark:text-text-gray">همراه ما باشید!</p>

    ...
    return (
        <form  className=' w-full flex flex-col items-center gap-y-4'>
            <div className="w-full h-auto mt-4 flex flex-col">
                ...
                <input type="email" name="email" placeholder='ایمیل خود را وارد کنید' className="outline-none border px-4 py-2 mt-2 rounded-xl bg-white dark:bg-gray-700 dark:border-slate-500 dark:text-text-gray "  {...formik.getFieldProps("email")}/>
            ...
            <input type="tel" className='outline-none border dark:border-slate-500 px-4 py-2 mt-2 rounded-xl bg-white dark:text-text-gray dark:bg-gray-700' 
                name='password'
            ...
            <button className='w-full py-2 text-slate-50 bg-gradient-to-r from-blue-300 to-purple-600 dark:from-gray-500 mt-10 rounded-xl' onClick={formik.handleSubmit}>
                    ورود
            </button>
